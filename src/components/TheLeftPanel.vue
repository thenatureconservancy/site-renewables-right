    ...
    <q-scroll-area style="height: calc(100vh)">
      <div class="bg-white q-pr-md">
        ...
        <div class="q-mt-md q-mb-md bg-white text-left row">
          ...
          <q-btn square padding="xs" flat size="sm" stack color="blue-grey-9" class="q-ml-md" @click="openPanel()">
            <q-tooltip>Get site report</q-tooltip>
            <calcite-icon class="q-mb-xs" icon="file-report" scale="m"></calcite-icon>Site Report
          </q-btn>
        </div>
